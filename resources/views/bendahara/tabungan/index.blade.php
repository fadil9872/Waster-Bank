                ...
                <tbody class="filter-box">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="delete/{{$value->id}}" method="post" class="d-inline ml-2" onsubmit="return confirm('yakin hapus data')">
                                @method('delete')
                                @csrf
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="tambah" method="post">
                                    <div class="modal-body">
                                        @csrf
                                        <input type="hidden" class="form-control" value="{{$idku}}" name="user_id" >
                                        <div class="form-group row">
                                            <label for="keterangan" class="col-sm-2 col-form-label">Keterangan</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="kredit" class="col-sm-2 col-form-label">Kredit</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="kredit" name="kredit" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
